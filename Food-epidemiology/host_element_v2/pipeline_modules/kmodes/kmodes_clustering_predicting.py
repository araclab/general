...
parser.add_argument("input_tsv_data", help="User provided input tsv data file with columns as features (alleles) and rows as samples; manually rename the first column name to be 'Genome' if needed; generated from the cgmlstfinder script")
parser.add_argument("kmodes_model", help="User provided kmodes_model input in pkl format")
