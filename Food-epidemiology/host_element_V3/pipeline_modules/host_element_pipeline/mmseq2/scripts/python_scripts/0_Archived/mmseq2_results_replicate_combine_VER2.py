...
#
# dir_path = "/Users/edward.sung/Desktop/blast_update_workspace/updated_testrun_output/processing_files/Merged_FullPenile_03132025_species/results_replicates/"
# ref_file = "/Users/edward.sung/Desktop/blast_update_workspace/bvab_megasphaera_16S_reference.fasta"
# ref_file_numsize= "999"
# output_name = "Merged_FullPenile_03132025_species_hihi"
        ...
        if fasta_name in main_data_df_unique["Subject_Seq-id"].values:
            ...
            if subset_df.empty:
                ...
                if subset_filter_df.empty:
                    ...
                    # Since sorted by bitscore, the first row should have the best scores (May need to consider writing a loop function to ensure top hit)
                    best_bitscore = subset_filter_df["Bitscore"][0]
                    best_percent_identity = subset_filter_df["Percent_Identity"][0]

                    # Multipled by 100 because the default query coverage is [0-1], while percent_identity is [0-100]
                    best_subject_coverage = subset_filter_df["Subject_Coverage"][0] * 100
