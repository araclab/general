...
parser.add_argument("workding_dir")
parser.add_argument("results_file")
parser.add_argument("kma_fsa_file")
args = parser.parse_args()

os.chdir(args.workding_dir)
results_file_intput = args.results_file
...
#
# results_file_intput = "ESC_GA3724AA_AS/ecoli_results.txt"
# kma_fsa_file_input = "ESC_GA3724AA_AS/kma_ESC_GA3724AA_AS.fsa"

#%%
cgmlst_results = pd.read_csv(results_file_intput, sep="\t")
